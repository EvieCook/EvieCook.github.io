...
const VanguardScholarsProgram = () => {
  return (
        ...
        <p>The Vanguard Scholars Program is a community of scholars for highly motivated students who embody leadership skills and desire to improve our world through STEM. Through Vanguard, I have been able to gain leadership skills by planning events and activites to help welcome the incoming freshman to campus. I have had the oppurtunity to plan crafting, networking, and ZOOM events to introduce the new students to faculty, upper-classman, and fellow new students. The most recent event was a vision board activity, where the incoming freshman got to create goals for themselves about what they wanted to accomplish during their first year of college.</p>
